...
//   // Function to fetch and display videos based on category
//   const handleVideoLoad = async (cat = "1000") => {
//     sortHandler = cat;
//     try {
//       const res = await fetch(https://openapi.programming-hero.com/api/videos/category/${cat});
...
//     if (videos.length > 0) {
//       videos.sort((a, b) => {
//         const view1 = parseInt(a.others.views.replace(/,/g, ''), 10); // Remove commas and parse as integer
//         const view2 = parseInt(b.others.views.replace(/,/g, ''), 10); // Remove commas and parse as integer
//         return view2 - view1; // Sort in descending order
//       });
